 ...
 * 
 * \exception MissingArgument will be emitted if an argument has been flagged, but no value
 *                            can be found
 * \exception UnknownArgument will be emitted if an unrecognised argument has been flagged
 */
